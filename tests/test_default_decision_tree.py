...
def test_branch1():
    ...
    obs, diags = harmonize.default_methods(hist, df, '2015', offset_method='reduce_offset_2050')
...
def test_branch3():
    ...
    obs, diags = harmonize.default_methods(hist, df, '2015', ratio_method='reduce_ratio_2050')
